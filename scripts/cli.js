...
const contractABI = require("../artifacts/contracts/Ethereumnode.sol/Ethereumnode.json").abi;

program
    .name("ethereumnode-cli")
    .description("CLI tool for Ethereumnode smart contract")
    .version("1.0.0");
